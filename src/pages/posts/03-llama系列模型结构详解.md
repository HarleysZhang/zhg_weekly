<img src="https://p.ipic.vip/tgljfl.jpg" width="800" />  

<small>本文主要从模型推理角度去总结 llama1-3 模型论文和报告，因此没有涉及到数据集处理、模型训练及试验报告的细节，更多的是介绍了 LLaMA 模型的主要思想以及模型结构的细节。</small>  
...
![完整的llama模型结构](https://p.ipic.vip/w4lhm1.jpg)
...
![llama_parameters](https://p.ipic.vip/xmtpgs.jpg)
...
<img src="https://p.ipic.vip/esmgco.jpg" width="50%" alt="ffn">
...
<img src="https://p.ipic.vip/sygsdy.jpg" width="55%" alt="swish_activation">
...
<img src="https://p.ipic.vip/qm774d.jpg" width="60%" alt="ffn_var">
...
<img src="https://p.ipic.vip/gx54t8.jpg" width="50%" alt="ffn_structrue">
...
![Vicuna-demo](https://p.ipic.vip/2w6dwv.jpg)
...
<img src="https://p.ipic.vip/i8jy2p.jpg" width="50%" alt="GQA_visual">

`MHA`、 `MQA` 和 `GQA` 原理的可视化对比如下图所示:

<img src="https://p.ipic.vip/69ejsr.jpg" width="70%" alt="GQA_visual">
