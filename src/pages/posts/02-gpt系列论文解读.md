<img src="https://p.ipic.vip/fwoinr.jpg" width="800" />  

<small>GPT3.5 是一个系列模型，也就是保持基本训练框架不变，用不同的数据做指令微调，会得到不同的模型，这些模型都叫做 GPT3.5。</small>  
...
![nlp 子任务的转换](https://p.ipic.vip/fwoinr.jpg)
...
<img src="https://p.ipic.vip/lmcke9.jpg" width="40%" alt="gpt1模型结构">
...
![ 4 种 gpt2 参数](https://p.ipic.vip/6h4imi.jpg)
...
![Zero-shot, one-shot and few-shot, contrasted with traditional fine-tunin](https://p.ipic.vip/tmrjr5.jpg)
...
![8种不同尺寸的 gpt3 模型](https://p.ipic.vip/dxqhrx.jpg)
...
![gpt3训练数据集](https://p.ipic.vip/1mwdfw.jpg)
